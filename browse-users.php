...
<head>
	...
	<title>Voters Roll Group 2</title>
...
<body>
	...
	<?php
	$condition	=	'';
	if(isset($_REQUEST['surname']) and $_REQUEST['surname']!=""){
		$condition	.=	' AND surname LIKE "%'.$_REQUEST['surname'].'%" ';
	}
	if(isset($_REQUEST['firstname']) and $_REQUEST['firstname']!=""){
		$condition	.=	' AND firstname LIKE "%'.$_REQUEST['firstname'].'%" ';
	}
	if(isset($_REQUEST['idnumber']) and $_REQUEST['idnumber']!=""){
		$condition	.=	' AND idnumber LIKE "%'.$_REQUEST['idnumber'].'%" ';
	}
	...
	?>
   	<div class="container">
		<h1><a href="">Voters Roll Inspection System</a></h1>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse Voters</strong> <!--<a href="add-users.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add Users</a>--></div>
			<div class="card-body">
				<?php
				...
				?>
				<div class="col-sm-12">
					<h5 class="card-title"><i class="fa fa-fw fa-search"></i> Find Voters</h5>
					<form method="get">
						<div class="row">
							<div class="col-sm-2">
							...
							<div class="col-sm-2">
								<div class="form-group">
									...
									<input type="tel" name="idnumber" id="idnumber" class="form-control" value="<?php echo isset($_REQUEST['idnumber'])?$_REQUEST['idnumber']:''?>" placeholder="Enter idnumber">
								</div>
							</div>
							<!--<div class="col-sm-4">
